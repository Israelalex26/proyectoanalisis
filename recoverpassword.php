...
<body>
    ...
    <nav class="nav1_recoverpassword">
        ...
        <span class="description">Debes ingresar el correo electrónico con el que te registraste.</span>
        <form action="recoverpassword.php" method="POST">
            <div class="div_correo">
                ...
                <input type="text" id="correo_electronico" name="correo_electronico" class="input_correo"
...
function enviar($correo, $link) {
    ...
    $body = "<div style='text-align: center;'>
        ...
        <div style='border: 1px solid #C1C1C1; padding: 20px; border-radius: 5px; display: inline-block;'>
            ...
            <p>Si no intentaste restablecer tu contraseña, puedes ignorar este correo. <br> Para obtener un nuevo enlace para restablecer la contraseña, visita: <a href='http://nominasolidarista.wuaze.com/recoverpassword.php'>$link</a></p>
