  ...
  task.on(
    ...
    () => {
      ...
      task.snapshot.ref.getDownloadURL().then((downloadURL) => {
        // Save download URL to Firestore or wherever you need it
        console.log('Download URL:', downloadURL);
        document.getElementById('foto_empleado').value = downloadURL;
   ...
   task.on(
     ...
     () => {
       ...
       task.snapshot.ref.getDownloadURL().then((downloadURL) => {
         ...
         console.log('Download URL:', downloadURL);
         document.getElementById('expediente_empleado').value = downloadURL;
       });
     }
   );
 }
